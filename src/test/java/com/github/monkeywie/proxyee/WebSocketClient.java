...
public class WebSocketClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 连接到 WebSocket 服务器
//            Session session = client.connectToServer(WebSocketClient.class, URI.create("ws://10.10.20.100/gateway/notify-service/socket?clientId=pc&Authorization=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjYWNoZUtleSI6IkNPTlNPTEU6VVNFUl9UT0tFTjpjaGVucXA6MjkxNzY2OTgyMzY5MTkxMTE2OCIsImNsaWVudENvZGUiOiI4MDAiLCJpc3MiOiJNSU5HIiwiaXNBcHAiOiJmYWxzZSIsInVzZXJDb2RlIjoiY2hlbnFwIn0.yBgJ5S2FqUcfz92KKU_IGWzdRkGi5fDTd5-Hrh2OZ_U"));
            Session session = client.connectToServer(WebSocketClient.class, URI.create("wss://im-linkserver-61.csdn.net/"));
